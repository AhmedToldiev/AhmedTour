    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          ...
          description: "Погрузитесь в захватывающий мир Кабардино-Балкарии в рамках уникального тура Кабардино-Балкария в Первоклассном Путешествии по Стране гор. В течение одного увлекательного тура вы посетите не только культурные и исторические наследия, но и окунетесь в великолепие природных чудес.",
          price: 50000,
          photoTourId: 5,
          regionId: 3,
        },
        {
          ...
          description: "Пройдите по извилистым тропам, ведущим к вершинам Кавказских гор, и ощутите величие местного ландшафта. Ваш путь будет пересечен потрясающими горными реками, исходящими из высокогорных ледников, наполняющими воздух свежестью и благоуханием природы. Погрузитесь в приключение, исследуя глубокие каньоны, вырезанные веками водой. Скалы, поднимающиеся вокруг, будут свидетелями истории, рассказывая вам о могуществе природных сил. Откройте для себя магию каньонов, где каждый поворот скрывает в себе новые удивительные пейзажи.",
          price: 50000,
          photoTourId: 6,
          regionId: 3,
        },
        
        {
          ...
          body: "Описание: Погрузитесь в атмосферу волшебства, исследуя прекрасные долины Чечни, насыщенные историей и неповторимой природой.",
          description:"",
          price: 50000 ,
          photoTourId: 7,
          regionId: 4,
