  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert(
      ...
      [
        ...
        {
          name: 'Ингушетия ',
          description: 'Путешествия по Кавказу становятся всё популярнее, но Ингушетия порой остаётся без должного внимания. Самая маленькая республика региона кружит голову идиллическими пейзажами и древними легендами. А уникальные башенные комплексы манят исследовать многовековые тайны, сокрытые в каменных стенах. Отправимся открывать «страну башен», где слышны отголоски чеченской, осетинской и грузинской культур.',
          img: 'https://img.tourister.ru/files/3/0/0/6/9/4/9/6/clones/870_653_fixedwidth.jpg'
        },
        {
          name: 'Чечня',
          description: 'Чечня — одна из республик на Северном Кавказе, вокруг которой раскинулись живописные хребты Кавказских гор. Туристы сюда едут ради особой культуры, традиций горных народов, различных достопримечательностей и, конечно, природы. Самое большое горное озеро на Северном Кавказе, самый большой некрополь, самобытная кухня, низкие цены и небольшая территория республики — вот далеко не все особенности Чечни.',
